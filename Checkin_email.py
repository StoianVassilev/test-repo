#!/usr/bin/env python3
"""
Raspberry Pi Checkin Email Script
Sends an email with the Pi's serial number and IP address daily to check in.
"""
...
def send_email():
    ...
    subject = f"RPi Checkin Report: {hostname} : {ip_address} : {current_time}"
    body = f"""
Check in from Raspberry Pi:
